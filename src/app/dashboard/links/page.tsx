  ...
  return (
    <div className="p-4 pb-12">
      <div className="flex flex-col relative bg-white rounded-md">
        <div className="p-6">
          <h1 className="text-2xl mb-3">Customize your links</h1>
          ...
          <div className="mt-6">
            <button className="w-full px-3 py-2 rounded-md font-bold border-solid border-2 border-purple-500 hover:bg-purple-100 text-purple-500 focus:ring-2">
              + Add new link
            </button>
          </div>

          <div className="flex flex-col items-center rounded-md bg-gray-50 mt-6 p-4 py-8">
            <svg
